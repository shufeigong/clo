...
if (!class_exists('SLP_Settings')) {
    ...
    class SLP_Settings extends SLPlus_BaseClass_Object {
        ...
        function render_settings_page() {
            ...
            print
                    '<div id="wpcsl_container" class="wrap settings_page">' .
                    "<h1>{$this->name}</h1>" .
                    "<form method='post' " .
            ...
            //
			print '<div id="main" class="main_content">';                                        // Open Main
            // Menu Area
            //
            ...
            $firstOne = true;
            echo
            '<div id="wpcsl-nav" class="sub_navigation" style="display: block;">' . // Open Nav
            '<ul>';
            foreach ($this->sections as $section) {
                if ($section->auto) {
            ...
            '<div id="content" class="content js">'                     // Open Content
            ;
    ...
    class SLPlus_Settings_Section extends SLPlus_BaseClass_Object {
        ...
        function add_item($params) {
            ...
            if (!isset($this->groups[$groupSlug])) {
                $this->groups[$groupSlug] = new SLPlus_Settings_Group(
                        array(
                    'slplus' => $this->slplus,
                    'slug' => $groupSlug,
                    'header' => $params['group'],
        ...
        function header() {
            ...
            "class='{$groupClass} group_{$friendlyDiv}' " .
            ">";
...
if (!class_exists('SLPlus_Settings_Item')) {
    ...
    class SLPlus_Settings_Item extends SLPlus_BaseClass_Object {
        ...
        private function create_string_list() {
            $content = "<select class='csl_select' " .
        ...
        function display() {
            ...
            echo "<div class='input-field wpcsl-input wpcsl-{$this->type} {$disabled_class}'>";
            ...
            // It should stay inside the <input> column.
            if (!is_null($this->description)) {
