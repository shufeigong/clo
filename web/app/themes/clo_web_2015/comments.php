...
if ( comments_open() ) :
	if ( (is_page() || is_single()) && ( ! is_home() && ! is_front_page()) ) :
?>
<section id="respond" class="entry-content2">
	...
	<form action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p>
			<label for="author">
				<?php
					_e( 'Name', 'foundationpress' ); if ( $req ) { _e( ' *', 'foundationpress' ); }
				?>
			</label>
			<input type="text" class="five" name="author" id="author" value="<?php echo esc_attr( $comment_author ); ?>" size="30" tabindex="1" <?php if ( $req ) { echo "aria-required='true'"; } ?>>
		</p>
		<p>
			<label for="email">
				<?php
					_e( 'Email', 'foundationpress' ); if ( $req ) { _e( ' *', 'foundationpress' ); }
				?>
			</label>
			<input type="text" class="five" name="email" id="email" value="<?php echo esc_attr( $comment_author_email ); ?>" size="30" tabindex="2" <?php if ( $req ) { echo "aria-required='true'"; } ?>>
		</p>
		<p>
			<label for="url">
				<?php
			...
			<input type="text" class="five" name="url" id="url" value="<?php echo esc_attr( $comment_author_url ); ?>" size="30" tabindex="3">
		</p>
		<?php endif; ?>
		<p>
			<label for="comment">
			...
			<textarea name="comment" id="comment" tabindex="4" cols="45" rows="8"></textarea>
		</p>
		...
		<p><input name="submit" class="commentbutton" type="submit" id="submit" tabindex="5" value="<?php esc_attr_e( 'Post Comment', 'foundationpress' ); ?>"></p>
