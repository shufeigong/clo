...
if (!class_exists('Foundationpress_Top_Bar_Walker')) :
	...
	<rect x="378" y="27.8" fill="#82BC00" class="st0" width="791" height="3.1"/></svg>';
						break;
					case 6:
						$output .= '<svg style="position: absolute; bottom: 0;z-index:10;" id="Layer_6" xmlns="http://www.w3.org/2000/svg" viewBox="0 12 783 18"><style>#Layer_6 .st0{fill:#82BC00;}</style><path class="st0" d="M-11.7 26.9H798V30H-11.7z"/></svg>';
						break;
					case 7:
						$output .= '<svg style="position: absolute; bottom: 0;z-index:10;" id="Layer_7" xmlns="http://www.w3.org/2000/svg" viewBox="0 12 783 18"><style>#Layer_7 .st0{fill:#82BC00;}</style><path class="st0" d="M-11.7 26.9H798V30H-11.7z"/></svg>';
						break;
				}
			}
			else {
