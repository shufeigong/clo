		     ...
		     if(response.items[i].parent==itemJsonId)
		    	 {
		    	   if(response.items[i].children.length>0)
		    	       {output+='<li><a href="#" onclick="signclick(this); return false;" style="color:#808285">[-]</a><a href="#" onclick="change('+response.items[i].object_id+',\''+itemId+'\'); return false;" style="color:#808285" id="'+response.items[i].ID+'">'+response.items[i].title+'</a></li>';}
		    	   else
		    		   {output+='<li><a href="#" onclick="change('+response.items[i].object_id+',\''+itemId+'\'); return false;" style="color:#808285; padding-left:10%" id="'+response.items[i].ID+'">'+response.items[i].title+'</a></li>';}
		    	 }
		  }
